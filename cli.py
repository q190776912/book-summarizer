...
DISPATCH = {
    ...
    "fmt-proofs": "flows/write-source/script/fmt_proofs.py",
    "fmt-extras": "flows/write-source/script/fmt_extras.py",
    "wrap-examples": "flows/write-source/script/wrap_examples_bq.py",
