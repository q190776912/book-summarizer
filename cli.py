...
DISPATCH = {
    ...
    "fmt-extras": "flows/write-source/format/script/format/fmt_extras.py",
    "mathify": "flows/write-source/format/script/format/mathify_plaintext.py",
    "unwrap-bq": "flows/write-source/format/script/format/unwrap_blockquote_items.py",
    "wrap-examples": "flows/write-source/format/script/format/wrap_examples_bq.py",
    "extract-figures": "flows/script/figure/extract_figures.py",
    "assign-figures": "flows/script/figure/assign_figures.py",
    "embed-figures": "flows/script/figure/embed_figures.py",
    "apply-manual-figures": "config/figure_manual_chN/apply_manual_figures.py",
    "inspect-figures": "flows/script/figure/inspect_tool.py",
