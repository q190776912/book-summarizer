...
DISPATCH = {
    ...
    "check-katex": "flows/write-source/format/script/check_katex.py",
    "fmt-proofs": "flows/write-source/format/script/fmt_proofs.py",
    "fmt-extras": "flows/write-source/format/script/fmt_extras.py",
    "mathify": "flows/write-source/format/script/mathify_plaintext.py",
    "unwrap-bq": "flows/write-source/format/script/unwrap_blockquote_items.py",
