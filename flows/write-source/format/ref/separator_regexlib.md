...
### T03 — `../../../../verify/layers/numbering_gap/script/numbering_gap.py` 改造：去重 + 健壮性（不改分级/分组/label-first）  【P0，依赖 T01】
