...
# 本层的语义 / 阈值 / --fix 范围 / 字节契约键 的权威说明见 verify/layers/katex_validation/katex_validation.md（SSOT）；本文件仅含实现，勿在此复述叙事。
"""
katex_validation.py — C-LAYER (order 4): KaTeX validation.
