# 本层的语义 / 阈值 / --fix 范围 / 字节契约键 的权威说明见 references/layers/f.md（SSOT）；本文件仅含实现，勿在此复述叙事。
"""
f_layer.py — F-LAYER (order 6): figure validity (analog of C-layer).
...
from verify.layers._fig_common import load_figure_index, cv2
