...
# 本层的语义 / 阈值 / --fix 范围 / 字节契约键 的权威说明见 verify/layers/intra_item_dash/intra_item_dash.md（SSOT）；本文件仅含实现，勿在此复述叙事。
"""intra_item_dash.py — J-LAYER (order 10, fix_order 7): no `---` inside an item block.
