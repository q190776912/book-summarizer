...
Usage (run from the skill root so `verify.layers.script.formula_tag` is importable):
  python verify/layers/script/_reconcile_book_formulas.py <extract_dir> <md_file> <first> <last> [out_md]
"""
