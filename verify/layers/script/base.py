"""verify/layers/script/base.py — layer contract, registry, orchestration, and the
...
DEFAULT_RESULT: Dict[str, Any] = {
    ...
    # Top-level mirror of d_layer['levels'] (declared in verify/layers/section_continuity/section_continuity.md's
