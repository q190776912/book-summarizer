...
# 本层的语义 / 阈值 / --fix 范围 / 字节契约键 的权威说明见 verify/layers/structural_label_guard/structural_label_guard.md（SSOT）；本文件仅含实现，勿在此复述叙事。
"""
structural_label_guard.py — H-LAYER (order 8, fix_order 1): structural label / blockquote audit.
