...
Usage (run from the skill root so `verify.layers.q_layer` is importable):
  python verify/reconcile_book_formulas.py <extract_dir> <md_file> <first> <last> [out_md]
"""
...
from verify.layers.q_layer import (build_formula_patterns, SourceFormulaIndex,
                            _section_match)
